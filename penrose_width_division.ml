...
let width_division generation triangles type_init points =
  let rec divide_current_gen generation triangles type_triangles points next_gen type_next_gen points_next_gen= match generation, triangles, type_triangles with
    |0, _, _ ->
       begin
	 wait 1.;
	 draw points
